...
CREATE TABLE "game_object_components" (
...
CREATE TABLE "prefab_property_overrides" (
  "id"              INTEGER PRIMARY KEY,
...
CREATE INDEX "idx_objects_asset_class"     ON "objects"                   ("asset_id", "class_id");
CREATE INDEX "idx_objects_class"           ON "objects"                   ("class_id");
CREATE INDEX "idx_objects_prefab_instance" ON "objects"                   ("prefab_instance_id");
CREATE INDEX "idx_go_name"                 ON "game_objects"              ("name");
CREATE INDEX "idx_go_tag"                  ON "game_objects"              ("tag");
CREATE INDEX "idx_go_layer"                ON "game_objects"              ("layer");
CREATE INDEX "idx_goc_component"           ON "game_object_components"    ("component_id");
CREATE INDEX "idx_goc_enabled"             ON "game_object_components"    ("enabled");
CREATE INDEX "idx_transforms_parent"       ON "transforms"                ("parent_id");
CREATE INDEX "idx_transforms_go"           ON "transforms"                ("game_object_id");
CREATE INDEX "idx_prefab_source_guid"      ON "prefab_instances"          ("source_prefab_guid");
CREATE INDEX "idx_object_fields_kv"        ON "object_fields"             ("key", "value");
CREATE INDEX "idx_ppo_instance"            ON "prefab_property_overrides" ("instance_id");
CREATE INDEX "idx_ppo_target"              ON "prefab_property_overrides" ("target_guid", "target_file_id");
CREATE INDEX "idx_additions_instance"      ON "prefab_additions"          ("instance_id");
CREATE INDEX "idx_refs_to_guid"            ON "asset_references"          ("to_guid");